    ...
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl" data-testid="text-page-title">Sign in to LocalHub</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/signup" className="font-medium text-primary underline-offset-4 hover:underline" data-testid="link-signup">
              Sign up
            </Link>
          </div>
        </CardContent>
...
export function SignupPage() {
  ...
  const form = useForm<SignupData>({
    ...
    defaultValues: { email: "", password: "", firstName: "", lastName: "", phone: "", location: "" },
  });
    ...
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl" data-testid="text-page-title">Create your account</CardTitle>
          <CardDescription>Join LocalHub to discover and offer local services</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="font-medium text-primary underline-offset-4 hover:underline" data-testid="link-login">
              Sign in
            </Link>
          </div>
        </CardContent>
